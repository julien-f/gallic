...
final class GallicTest extends GallicTest_Base
{
	/**
	 * @covers Gallic
	 */
	function testVersionAndVersionIdConcordance()
	{
		list($major, $minor, $revision) = explode('.', Gallic::VERSION);

		$this->assertSame(Gallic::VERSION_ID,
		                  ($major*100 + $minor)*100 + $revision);
	}
}
